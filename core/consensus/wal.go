...
import (
	...
	auto "github.com/YAOChain/yao/core/libs/autofile"
...
func RegisterWALMessages(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(types.EventDataRoundState{}, "yao/wal/EventDataRoundState", nil)
	cdc.RegisterConcrete(msgInfo{}, "yao/wal/MsgInfo", nil)
	cdc.RegisterConcrete(timeoutInfo{}, "yao/wal/TimeoutInfo", nil)
	cdc.RegisterConcrete(EndHeightMessage{}, "yao/wal/EndHeightMessage", nil)
}
