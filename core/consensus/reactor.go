...
import (
	...
	cstypes "github.com/YAOChain/yao/core/consensus/types"
	cmn "github.com/YAOChain/yao/core/libs/common"
	tmevents "github.com/YAOChain/yao/core/libs/events"
...
func RegisterConsensusMessages(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&NewRoundStepMessage{}, "yao/NewRoundStepMessage", nil)
	cdc.RegisterConcrete(&NewValidBlockMessage{}, "yao/NewValidBlockMessage", nil)
	cdc.RegisterConcrete(&ProposalMessage{}, "yao/Proposal", nil)
	cdc.RegisterConcrete(&ProposalPOLMessage{}, "yao/ProposalPOL", nil)
	cdc.RegisterConcrete(&BlockPartMessage{}, "yao/BlockPart", nil)
	cdc.RegisterConcrete(&VoteMessage{}, "yao/Vote", nil)
	cdc.RegisterConcrete(&HasVoteMessage{}, "yao/HasVote", nil)
	cdc.RegisterConcrete(&VoteSetMaj23Message{}, "yao/VoteSetMaj23", nil)
	cdc.RegisterConcrete(&VoteSetBitsMessage{}, "yao/VoteSetBits", nil)
}
