...
import (
	...
	flow "github.com/YAOChain/yao/core/libs/flowrate"
...
func RegisterPacket(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(PacketPing{}, "yao/p2p/PacketPing", nil)
	cdc.RegisterConcrete(PacketPong{}, "yao/p2p/PacketPong", nil)
	cdc.RegisterConcrete(PacketMsg{}, "yao/p2p/PacketMsg", nil)
}
