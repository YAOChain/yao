...
import (
	...
	"github.com/YAOChain/yao/core/crypto/tmhash"
...
func RegisterEvidences(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&DuplicateVoteEvidence{}, "yao/DuplicateVoteEvidence", nil)
}

func RegisterMockEvidences(cdc *amino.Codec) {
	cdc.RegisterConcrete(MockGoodEvidence{}, "yao/MockGoodEvidence", nil)
	cdc.RegisterConcrete(MockRandomGoodEvidence{}, "yao/MockRandomGoodEvidence", nil)
	cdc.RegisterConcrete(MockBadEvidence{}, "yao/MockBadEvidence", nil)
}
