...
import (
	...
	store "github.com/YAOChain/yao/store/types"
...
func registerTestCodec(cdc *codec.Codec) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "yao/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "yao/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "yao/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "yao/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "yao/baseapp/msgNoDecode", nil)
